...
| DenseNet40 | 0.806 ± 0.107 | 0.747 ± 0.078 | 0.487 ± 0.221 | 0.784 ± 0.061 |
| **ViT** | **0.841 ± 0.059** | **0.759 ± 0.058** | **0.550 ± 0.158** | **0.835 ± 0.040** |

These are the published Table 1 values. The column order matches `format_table` in [superager/stats.py](superager/stats.py) exactly.
